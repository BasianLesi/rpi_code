...
function sendMessage() {
  ...
  if(messageId > 1) process.exit(1); //terminate process after sending the first message
}
...
})("HostName=raspberryDataTest.azure-devices.net;DeviceId=raspberryPi_3;SharedAccessKey=H/MGDPZ5cREwJL66h1PXIJLO+hiAqq2pf2sHBXKMtRU=");
